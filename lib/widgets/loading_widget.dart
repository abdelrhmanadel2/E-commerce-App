...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint = Paint();
    paint.color = kDarkPrimaryColor.withOpacity(_opacity);
    ...
    Paint paint3 = Paint();
    paint3.color = Get.isDarkMode?kBackgroundColor.withOpacity(_opacity2):kDarkBackgroundColor.withOpacity(_opacity2);
    ...
    Paint paint4 = Paint();
    paint4.color = kDarkGrayColor.withOpacity(_opacity3);
